...
export default function GuidancePage() {
  ...
  return (
    <div className="pb-24 px-4 max-w-lg mx-auto">
      ...
      {selectedExercise && (
        <div
          className="fixed inset-0 bg-black/70 z-50 flex items-end sm:items-center justify-center animate-modal-overlay"
          onClick={() => setSelectedExercise(null)}
        >
          <div
            className="bg-[#1a1a1a] border border-[#333] rounded-t-3xl sm:rounded-3xl w-full sm:max-w-md max-h-[80vh] overflow-y-auto p-6 animate-modal"
